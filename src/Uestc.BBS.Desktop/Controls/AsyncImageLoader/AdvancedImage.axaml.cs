...
public class AdvancedImage(Uri? baseUri) : ContentControl
{
    ...
    public static readonly DirectProperty<
        AdvancedImage,
        bool
    > ShouldLoaderChangeTriggerUpdateProperty = AvaloniaProperty.RegisterDirect<
        AdvancedImage,
        bool
    >(
    ...
    {
        AffectsRender<AdvancedImage>(
            CurrentImageProperty,
            StretchProperty,
            StretchDirectionProperty,
            CornerRadiusProperty
        );
        AffectsMeasure<AdvancedImage>(
            CurrentImageProperty,
            StretchProperty,
            StretchDirectionProperty
        );
    ...
    public bool ShouldLoaderChangeTriggerUpdate
    {
        ...
        set =>
            SetAndRaise(
                ShouldLoaderChangeTriggerUpdateProperty,
    ...
    public override void Render(DrawingContext context)
    {
        ...
        if (source != null && Bounds is { Width: > 0, Height: > 0 })
        {
            ...
            DrawingContext.PushedState? pushedState = _isCornerRadiusUsed
                ? context.PushClip(_cornerRadiusClip)
                : null;
